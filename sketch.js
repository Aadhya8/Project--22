...
ball1 = Bodies.circle(320,250,40,ball_options);
World.add(world,ball1);

ball2 = Bodies.circle(360,250,40,ball_options);
World.add(world,ball2);

ball3 = Bodies.circle(400,250,40,ball_options);
World.add(world,ball3);

ball4 = Bodies.circle(440,250,40,ball_options);
World.add(world,ball4);

ball5 = Bodies.circle(480,250,40,ball_options);
...
function keyPressed(){
	if(keyCode === UP_ARROW)
	{
		Matter.Body.applyForce(ball1,{x:0,y:0},{x:-50,y:-45});
	}
}